...
public static class DataFlowSampleService
{
    ...
    /// </summary>
    public static DiscountResult DeriveLeaseDiscountTier(decimal annualRent)
    {
        var tier = ClassifyTier(annualRent); // cross-function definition
    ...
    private static string ClassifyTier(decimal annualRent) =>
        annualRent >= 60000 ? "gold" : annualRent >= 24000 ? "silver" : "standard";
