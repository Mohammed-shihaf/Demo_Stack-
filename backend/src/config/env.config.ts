...
const defaultProtoPath = path.resolve(__dirname, '../../../shared/proto/record.proto');
const distProtoPath = path.resolve(__dirname, '../../../../shared/proto/record.proto');
...
export const env: EnvConfig = {
  ...
  protoPath: fs.existsSync(defaultProtoPath) ? defaultProtoPath : distProtoPath,
};
