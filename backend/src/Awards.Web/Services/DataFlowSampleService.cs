...
public static class DataFlowSampleService
{
    ...
    /// </summary>
    public static DiscountResult DeriveDiscountTier(decimal grantTotal)
    {
        var tier = ClassifyTier(grantTotal); // cross-function definition
    ...
    private static string ClassifyTier(decimal grantTotal) =>
        grantTotal >= 100000 ? "gold" : grantTotal >= 25000 ? "silver" : "standard";
